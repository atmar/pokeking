    ...
    <div class="section">
      ...
      <div class="max-w-m w-full rounded overflow-hidden shadow-lg mx-auto bg-white">
        ...
        <div class="pokeking mx-auto w-full text-center m-10">
          <button v-if="!pokeking" @click="declarePokeking()" :disabled="loading" class="disabled:opacity-75 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Declare PokeKing</button>
        </div>
      </div>
      <poke-king ref="pokeking" />
    </div>
  </div>
</template>
